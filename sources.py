...
TIER7_INVESTMENT_CN = [
    ...
    # X/Twitter 热点追踪（通过GNews抓取社交媒体引爆的新闻）
    {"name": "GNews: X热点 semiconductor viral",
     "weight": 9, "tags": ["trending","X","semiconductor","hot"],
     "url": "https://news.google.com/rss/search?q=when:24h+semiconductor+chip+breaking+major+announcement&ceid=US:en&hl=en-US&gl=US"},
    {"name": "GNews: X热点 AI breakthrough",
     "weight": 9, "tags": ["trending","X","AI","hot"],
     "url": "https://news.google.com/rss/search?q=when:24h+AI+breakthrough+major+announcement+launch+release&ceid=US:en&hl=en-US&gl=US"},
    {"name": "GNews: X热点 NVIDIA TSMC hot",
     "weight": 10, "tags": ["trending","NVIDIA","TSMC","hot"],
